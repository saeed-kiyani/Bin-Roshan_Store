...
<body class="bg-[#f8f7f4] text-gray-900 antialiased">
        ...
        <header class="h-20 bg-white border-b border-gray-200 sticky top-0 z-30">
            ...
            <div class="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <button
                    ...
                    type="button"
                    class="lg:hidden w-10 h-10 border border-gray-200 flex items-center justify-center hover:border-black transition"
                ...
                <div class="flex items-center gap-3 ml-auto">
                    ...
                    <a
                        href="{{ route('shop') }}"
                        target="_blank"
                        class="hidden sm:inline-flex items-center gap-2 border border-gray-200 px-4 py-2.5 text-[9px] uppercase tracking-widest font-semibold text-gray-600 hover:border-black hover:text-black transition"
                    >
    ...
    <div class="hidden sm:block text-right">
        ...
        <p class="text-[9px] uppercase tracking-widest text-gray-400">
            Administrator
        </p>
    ...
    >
        ...
        <button
            type="submit"
            class="w-10 h-10 border border-gray-200 flex items-center justify-center text-gray-500 hover:border-red-400 hover:text-red-500 transition"
            title="Logout"
        >
