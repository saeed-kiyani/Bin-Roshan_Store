...
<section class="relative min-h-screen h-screen overflow-hidden bg-black">
    ...
    <div class="absolute inset-x-0 bottom-0 z-20">
        ...
        <div class="max-w-[1500px] mx-auto px-6 lg:px-12 pb-12 lg:pb-16">
            ...
            <div class="max-w-xl text-white">
                ...
                <p class="mt-6 max-w-md text-sm sm:text-base leading-7 text-white/85">
                ...
                <div class="mt-10 flex items-center gap-8 sm:gap-12">
                    ...
                    <div>
                        ...
                        <p class="text-xs tracking-widest opacity-60">
                            01
                        </p>
    ...
    @forelse($categories as $index => $category)
        ...
        <a
            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <h3 class="mt-2 text-2xl font-light">
                    {{ $category->name }}
                </h3>
...
<section class="relative overflow-hidden bg-black text-white">
    ...
    <div class="relative max-w-5xl mx-auto px-6 py-28 text-center">
        ...
        <p class="mt-6 max-w-2xl mx-auto text-gray-300 leading-7">
...
<section class="bg-black text-white">
    ...
    <div class="max-w-5xl mx-auto px-6 py-24 text-center">
        ...
        <p class="mt-5 text-gray-400 max-w-xl mx-auto leading-7">
